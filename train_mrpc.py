...
from dataset.mrpc_dataset import MRPCDataset
...
class Trainer:
    def __init__(self, max_seq_len,
        ...
        train_dataset = MRPCDataset(corpus_path=self.config["train_corpus_path"],
        ...
        test_dataset = MRPCDataset(corpus_path=self.config["test_corpus_path"],
                                    max_seq_len=self.max_seq_len)
