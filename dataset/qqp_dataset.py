...
class QQPDataset(Dataset):
    def __init__(self, corpus_path, max_seq_len=128):
        ...
        self.has_label = 'is_duplicate' in self.df
    ...
    def __getitem__(self, item):
        ...
        text1 = row.question1.strip()
        text2 = row.question2.strip()
        ...
        label = torch.LongTensor([row.is_duplicate]) if self.has_label else None
